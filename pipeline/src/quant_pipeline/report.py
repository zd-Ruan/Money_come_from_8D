...
<main>
  <section class="summary">
    ...
    <div class="metric"><div class="label">策略最大回撤</div><div class="value negative">{fmt_pct(base['strategy_max_drawdown'])}</div><div class="note">{relative_drawdown_note} · 成交率 {fmt_pct(base['fill_rate'])}</div></div>
